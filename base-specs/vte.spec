...
Source:       http://download.gnome.org/sources/%{name}/0.26/%{name}-%{version}.tar.bz2
...
#owner:yippi date:2011-11-08 type:bug
Patch3:       vte-03-void-return.diff
...
%changelog
* Wed nov 09 2011 - brian.cameron@oracle.com
- Bump to 0.26.2 to fix CR #7035088, an issue with gnome-terminal leaking file
  descriptors.
