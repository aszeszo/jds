...
Name:         gdm
License:      GPL v2, LGPL v2, MIT, zlib/libpng
...
Source:       http://download.gnome.org/sources/gdm/3.1/gdm-%{version}.tar.bz2
Source1:      box.png
Source2:      logo.png
...
Patch8:       gdm-08-lang.diff
# date:2009-10-16 owner:yippi type:branding
Patch9:       gdm-09-sol-notty.diff
# date:2009-10-13 owner:niall type:bug doo:10981
Patch10:      gdm-10-trusted-extensions.diff
...
libtoolize --force
aclocal-1.11 $ACLOCAL_FLAGS -I . -I ./m4
autoheader
...
- Add patch gdm-30-vt.diff to fix CR #7082840, where GDM does not return to
...
- Add patch gdm-29-linc-cleanup.diff to fix CR #7067741.
* Fri Jul 14 2011 - brian.cameron@oracle.com
- Add patch gdm-28-makefile.diff.
