#
# spec file for package SUNWgnome-python26 aka library/python-2/gnome-python-26
#
...
Name:              SUNWgnome-python26
IPS_package_name:  library/python-2/python-gnome-26
Meta(info.classification): %{classification_prefix}:Development/Python
Summary:           Python 2.6 support libraries for GNOME
Version:           %{gnome_python.version}
SUNW_BaseDir:      %{_basedir}
SUNW_Copyright:    %{name}.copyright
License:           %{gnome_python.license}
