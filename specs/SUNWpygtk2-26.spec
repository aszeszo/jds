#
# spec file for package SUNWpygtk2-26 aka library/python-2/gtk2-26
#
...
Name:              SUNWpygtk2-26
IPS_package_name:  library/python-2/pygtk2-26
Meta(info.classification): %{classification_prefix}:Development/Python
Summary:           Python 2.6 bindings for the Gtk+ library
Version:           %{pygtk2.version}
SUNW_BaseDir:      %{_basedir}
SUNW_Copyright:    %{name}.copyright
License:           %{pygtk2.license}
