...
# Remove GNU/Linux-specific PAM files.
...
%dir %attr (0755, root, bin) %{_sysconfdir}/dconf
%{_sysconfdir}/dconf/*
...
%dir %attr (0770, root, gdm) %{_localstatedir}/lib/gdm/.config
%attr (1640, root, gdm) %{_localstatedir}/lib/gdm/.config/dconf
