#
# spec file for package SUNWpygobject26 aka library/python-2/pygobject-26
#
...
Name:              SUNWpygobject26
IPS_package_name:  library/python-2/pygobject-26
Meta(info.classification): %{classification_prefix}:Development/Python
Summary:           Python 2.6 bindings for the GObject library
Version:           %{pygobject.version}
SUNW_BaseDir:      %{_basedir}
SUNW_Copyright:    %{name}.copyright
License:           %{pygobject.license}
...
%{_libdir}/libpyglib-gi-2.0-python2.6.so*
