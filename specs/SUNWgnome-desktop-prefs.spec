...
%config %ips_tag(original_name=SUNWgnome-desktop-prefs:%{@}) %{_datadir}/applications/mimeinfo.cache
%if %is_s10
...
%dir %attr (-, root, other) %{_datadir}/icons/hicolor/*/actions
...
%{_datadir}/icons/hicolor/*/actions/touchpad-disabled.svg
%{_datadir}/icons/hicolor/*/actions/touchpad-enabled.svg
%{_datadir}/icons/hicolor/*/actions/touchpad-disabled.png
%{_datadir}/icons/hicolor/*/actions/touchpad-enabled.png
