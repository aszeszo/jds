#
# spec file for package SUNWpyorbit26 aka library/python-2/pyorbit-26
#
...
Name:              SUNWpyorbit26
IPS_package_name:  library/python-2/pyorbit-26
Meta(info.classification): %{classification_prefix}:Development/Python
Summary:           Python 2.6 bindings for ORBit
Version:           %{pyorbit.version}
SUNW_BaseDir:      %{_basedir}
SUNW_Copyright:    %{name}.copyright
License:           %{pyorbit.license}
