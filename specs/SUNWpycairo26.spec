#
# spec file for package SUNWpycairo26 aka library/python-2/pycairo-26
#
...
Name:              SUNWpycairo26
IPS_package_name:  library/python-2/pycairo-26
Meta(info.classification): %{classification_prefix}:Development/Python
Summary:           Python 2.6 bindings for the Cairo graphics library
Version:           %{pycairo.version}
SUNW_BaseDir:      %{_basedir}
SUNW_Copyright:    %{name}.copyright
License:           %{pycairo.license}
